...
const DoctorDashboard = () => {
  ...
  useEffect(async () => {
    ...
    const getNamePatient = async (id) => {
      console.log(
        "Here are all stored patients (in getNamePatient): ",
        patients
      );
  ...
  // //React documentation useEffect exhaustive depts (dependencies)
 ...
 */
  ...
  console.log(
    "Here are all stored patients (later in the code/time): ",
    patients
  );
  return (
              ...
              <DynamicCard
                ...
                content={
                  <div>
                    ...
                    <MyCalendar onClick={eventClickHandler} events={calendarEvents} />
                  </div>
                }
              ></DynamicCard>
            </Col>
