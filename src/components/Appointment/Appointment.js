...
const Appointment = (props) => {
    ...
    const onDelete = async () => {
        ...
        setOpenDialog(false);
        setConfirmMessage("We deleted your appointment on " + res.startPoint);
        setOpenConfirm(true);
    };
                ...
                <CardContent>
                    <div> {props.appointment?.doctor_address}
                        ...
                        <div>
                            ...
                            <br></br>
                            {props.upcoming ?
                                <Button style={{marginLeft: 3}} size="small" color="primary"
                                        onClick={onClickDirections}>get directions</Button>
                                : ""}</div>
                    </div>
