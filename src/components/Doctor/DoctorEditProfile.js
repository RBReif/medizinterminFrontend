...
const DoctorEditProfile = (props) => {
  ...
  const onChangeToggle = (displayname) => {
    ...
    facIndex == -1
      ? facilityList.push(displayname)
      : facilityList.splice(facIndex, 1);
    return facilityList;
  };
          ...
          <Form>
            ...
            <Row>
              <Col sm={3}>
                ...
                ></DynamicDropdown>
                <FormHelperText>
                  {"Currently: " + doctor?.area_of_expertise}
                </FormHelperText>
              </Col>
              <Col sm={3}>
                <MultiSelectDropdown
              ...
              <Col sm={6}>
                ...
                />
                <FormHelperText>
                  {"Currently: " + doctor?.address?.address_value}
                </FormHelperText>
              </Col>
            </Row>
            <Row>
